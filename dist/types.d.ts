...
export declare type GoogleVizDrawToolbar = (
...
export declare type GoogleChartTicks =
  | {
      v: string | number;
      f: string | number;
    }[]
...
export declare type GoogleChartWrapperChartType =
  | "AnnotationChart"
  | "AreaChart"
  | "BarChart"
  | "BubbleChart"
...
export declare type GoogleVizEventName =
  | "ready"
  | "error"
  | "select"
  | "animationfinish"
...
export declare type GoogleChartPackages =
  | "corechart"
  | "charteditor"
  | "controls"
  | "calendar"
...
export declare type GoogleDataTableColumnType =
  | "string"
  | "number"
  | "boolean"
  | "date"
...
export declare type GoogleDataTableSortColumns =
  | number
  | {
      column: number;
      desc: boolean;
...
export declare type GoogleArrayToDataTable = (
  data: any[][],
...
export declare type ReactGoogleChartDashboardRender = ({
  renderControl,
  renderChart,
  renderToolbar,
}: {
