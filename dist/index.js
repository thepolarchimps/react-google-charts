 ...
 */ function useLoadScript(src, onLoad, onError) {
  useEffect(() => {
    ...
    if (
      foundScript === null || foundScript === void 0
        ? void 0
        : foundScript.dataset.loaded
    ) {
...
const loadDataTableFromSpreadSheet = async function (
  googleViz,
  spreadSheetUrl
) {
  let urlParams =
  ...
  return new Promise((resolve, reject) => {
    const headers = "".concat(
      urlParams.headers ? "headers=".concat(urlParams.headers) : "headers=0"
    );
    const queryString = "".concat(
      urlParams.query ? "&tq=".concat(encodeURIComponent(urlParams.query)) : ""
    );
    const gid = "".concat(urlParams.gid ? "&gid=".concat(urlParams.gid) : "");
    const sheet = "".concat(
      urlParams.sheet ? "&sheet=".concat(urlParams.sheet) : ""
    );
    const access_token = "".concat(
      urlParams.access_token
        ? "&access_token=".concat(urlParams.access_token)
        : ""
    );
    const urlQueryString = ""
      ...
      .concat(queryString)
      .concat(access_token);
    const urlToSpreadSheet = ""
      .concat(spreadSheetUrl, "/gviz/tq?")
      .concat(urlQueryString); //&tq=${queryString}`;
      ...
      if (response.isError()) {
        reject(
          "Error in query:  "
            ...
            .concat(response.getDetailedMessage())
        );
      } else {
    ...
    this.listenToLegendToggle = () => {
      ...
      google.visualization.events.addListener(
        ...
        () => {
          ...
          if (
            selection.length === 0 || // We want to listen to when a whole row is selected. This is the case only when row === null
            selection[0].row ||
            !dataTable
          ) {
            return;
  ...
  constructor(...args1) {
    ...
    this.getControlID = (id, index) => {
      ...
      if (typeof id === "undefined") {
        controlID = "googlechart-control-"
          .concat(index, "-")
          .concat(controlCounter);
      } else {
        controlID = id;
      }
      return controlID;
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        this.state.isReady && this.state.googleChartWrapper !== null
          ? /*#__PURE__*/ React.createElement(
              React.Fragment,
              null,
              /*#__PURE__*/ React.createElement(GoogleChartDataTable, {
    ...
    this.renderControl = function () {
      ...
      return _this1.state.isReady && _this1.state.googleChartControls !== null
        ? /*#__PURE__*/ React.createElement(
            React.Fragment,
            null,
            _this1.state.googleChartControls
              .filter((param) => {
  ...
  render() {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      this.state.loadingStatus === "ready" && this.state.google !== null
        ...
        ? errorElement
        : loader,
      /*#__PURE__*/ React.createElement(LoadGoogleCharts, {
